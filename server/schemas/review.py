...
class ReviewBase(BaseSchema):
    ...
    comment: Optional[str] = Field(
        None, description="Optional comment about the place")
...
class ReviewUpdate(BaseModel):
    ...
    rating: Optional[int] = Field(
        None, ge=1, le=5, description="Updated rating between 1 and 5")
    comment: Optional[str] = Field(
        None, description="Updated comment about the place")
