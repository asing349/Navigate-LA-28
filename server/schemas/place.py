...
class PlaceBase(BaseModel):
    ...
    description: Optional[str] = Field(None, description="Optional description of the place.")
    ...
    types: Optional[str] = Field(None, description="Comma-separated string of place categories/types.")
