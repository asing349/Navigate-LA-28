...
class CustomerUsage(CustomerUsageBase):
    ...
    """
    id: int = Field(..., description="Unique identifier for the customer usage record")
    user_id: int = Field(..., description="ID of the user associated with this usage record")
